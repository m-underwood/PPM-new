...
<html>
    ...
    <body>
        <div id="header">
            ...
            <div id="btnTheme" ><br>
				<?php echo $_SESSION['ppm_username'];?><br>
		...
		<div id "event">
            ...
            <div class="card-body">
                ...
                <h6 class="card-subtitle mb-2 text-muted">Price: <?php echo '£'.$row["product_price"]; ?></h6>
                <p class="card-text"><?php echo $row["product_type"]; ?></p>
                <a href="cart.php?action=addToCart&productID=<?php echo $row["productID"]; ?>" class="btn btn-primary">Add to Cart</a>
            </div>
